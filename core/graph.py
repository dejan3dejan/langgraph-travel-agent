...
async def _research_food_for_dest(dest: str, details: dict) -> list:
    ...
    logger.info(f"[{dest}] Cache miss for restaurants — searching via Gemini...")
...
async def _research_activity_for_dest(dest: str, details: dict) -> list:
    ...
    logger.info(f"[{dest}] Cache miss for activities — searching via Gemini...")
...
async def _research_hotel_for_dest(dest: str, details: dict) -> list:
    ...
    logger.info(f"[{dest}] Cache miss for hotels — searching via Gemini...")
